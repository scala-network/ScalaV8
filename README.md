...
* If you would like a specific [version/tag](https://github.com/scala-project/scala/tags), do a git checkout for that version. eg. 'v0.17.1.9'. If you don't care about the version and just want binaries from master, skip this step:
...
As of May 2020, the full Scala blockchain file is about 80 GB. One can store a pruned blockchain, which is about 28 GB.
